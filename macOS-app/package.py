...
app_path = '/Users/wetest/workplace/udt/third_party/macos-installer-builder/app/udt-desktop.app'
dmg_path = '%s/build/udt-desktop.dmg' % current_file_path
app_name = 'udt-desktop'
